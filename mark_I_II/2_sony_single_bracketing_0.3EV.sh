...
DELAY=0.0
# There is a need to introduce a static delay before we go for the next
# shot in the bracketing sequence
...
echo
# Here we are shifting the middle exposure shutter speed
...
echo
# Here we are shifting the middle exposure shutter speed once more
