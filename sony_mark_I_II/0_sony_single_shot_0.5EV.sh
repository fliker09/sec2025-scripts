...
# Most probably, the reason why it's unstable is because the PTP protocol is not aware that instead of the standard 0.3EV step it operates at 0.5EV step
DELAY=0.4
...
time gphoto2 --set-config-value=/main/capturesettings/shutterspeed=1/6000 --set-config-value=/main/capturesettings/capturemode="Single Shot"
echo
# Ensure that Shutter Speed was indeed set at the desired value, as it's not guaranteed in one try.
time check_shutter_speed 1/6000
echo
...
time for i in 1/3000 1/1500 1/750 1/350 1/200 1/90 1/45 1/20 1/10 1/6 1/3 7/10 15/10 3
do
