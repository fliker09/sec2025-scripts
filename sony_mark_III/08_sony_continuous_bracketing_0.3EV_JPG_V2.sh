...
tmux send-keys -t gphoto2_"$TIMESTAMP" 'set-config /main/capturesettings/capturemode=Bracketing C 3.0 Steps 5 Pictures' C-m 'set-config /main/capturesettings/shutterspeed=1/80' C-m 'set-config /main/capturesettings/imagequality=RAW+JPEG (Std)' C-m 'set-config /main/actions/bulb=0' C-m
